...
CREATE EVENT `Auto Delete` ON SCHEDULE EVERY 5 MINUTE STARTS '2020-04-14 15:35:32' ON COMPLETION NOT PRESERVE ENABLE DO DELETE FROM `salas` where fecha+86400 < UNIX_TIMESTAMP(CURRENT_TIMESTAMP())$$
